Func WorkingGUI()
	Global $workingGUI = GUICreate("Working", 400, 430)
	$list = GUICtrlCreateListView("File", 10, 10, 380, 380)
	_GUICtrlListView_SetColumnWidth($list, 0, 378)
	Global $workingopenbutton = GUICtrlCreateButton("Open", 345, 391, 45, 25)
	$delete = GUICtrlCreateButton("Delete", 10, 391, 45, 25)
	$rename = GUICtrlCreateButton("Change Name", 194, 391, 75, 25)
	$changeDate = GUICtrlCreateButton("Change Date", 118, 391, 75, 25)
