Func CorrectionGUI()
	Global $correctionsGUI = GUICreate("Needs Corrections", 300, 330)
	...
	$correctionsopenbutton = GUICtrlCreateButton("Open", 245, 291, 45, 25)
	$tosupervisor = GUICtrlCreateButton("Queue to Supervisor", 119, 291, 125, 25)
